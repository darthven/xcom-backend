export const EnglishLocale = {
    ...
    'Status was not found with id': 'Status was not found with id ',
    'No SBOL account found with this store`s INN': 'No SBOL account found with this store`s INN',
    'Prices cannot be counted for the next goods:': 'Prices cannot be counted for the next goods: ',
